    ...
    return Scaffold(
      body: Center(
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              Text('Coisa Fofa', style: GoogleFonts.playwriteAr(fontSize: 50)),
              Text('Exoval', style: GoogleFonts.playwriteAr(fontSize: 25)),
              SizedBox(height: 25),
              Image.network(
                'https://i.postimg.cc/N0vTnW1W/70230eef-a6df-47b7-9709-6acd741b6a0c.jpg',
              ),
